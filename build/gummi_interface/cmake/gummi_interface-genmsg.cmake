...
set(MSG_I_FLAGS "-Igummi_interface:/home/altair/ws_gummi_popeye/src/gummi_interface/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/altair/ws_gummi_popeye/src/gummi_interface/msg/Diagnostics.msg" NAME_WE)
add_custom_target(_gummi_interface_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "gummi_interface" "/home/altair/ws_gummi_popeye/src/gummi_interface/msg/Diagnostics.msg" ""
)
...
_generate_msg_cpp(gummi_interface
  "/home/altair/ws_gummi_popeye/src/gummi_interface/msg/Diagnostics.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/gummi_interface)
  install(CODE "execute_process(COMMAND \"/home/altair/.virtualenvs/gummi/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/gummi_interface\")")
  # install generated code
  install(
